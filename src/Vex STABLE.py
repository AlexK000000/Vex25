...
#THIS IS STABLE, DO NOT UPDATE UNTIL TEST WORKS BETTER ON CURRENT ROBOT THAN THIS
"""Reminder, Vex Stable is supposed to serve as a stable, working version of the code that
works on the current model of the robot. All commented out functions should be removed in this code"""
